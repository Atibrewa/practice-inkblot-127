...
public class InkBlot {
    ...
    public void generateInkBlot() {
        RandomWalk walkX=new RandomWalk(150,0,canvas.getWidth());
        RandomWalk walkY=new RandomWalk(150,0, canvas.getHeight());
        ...
        for(int i=0;i<15000;i++){
            Line line= advance(walkX,walkY);
            Color color=getColor(red, green,blue);
            line.setStrokeColor(color);
            canvas.add(line);
            Line lineTwo=mirror(advance(walkX,walkY));
            lineTwo.setStrokeColor(color);
            canvas.add(lineTwo);
            canvas.draw();
            canvas.pause(10);
        }
